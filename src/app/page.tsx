            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Confira meu último trabalho
                </h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Trabalhei em diversos projetos, desde sites simples até
                  aplicações web. Aqui estão alguns dos meus favoritos.
                </p>
              </div>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Quer conversar? Apenas me mande uma mensagem{" "}
                <Link
                ...
                e responderei  todas as solicitações.
              </p>
            </div>
          </BlurFade>
        </div>
